import { Image, StyleSheet, Platform, TextInput, Keyboard } from 'react-native'
	...
	return (
		...
		>
			...
			<ThemedView style={styles.stepContainer}>
				<ThemedText type="subtitle">Step 1: {keyboardHeight}</ThemedText>
				<ThemedText style={styles.status}>{keyboardStatus}</ThemedText>
				<ThemedText>
